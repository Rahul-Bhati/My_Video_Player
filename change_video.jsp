<%-- 
    ...
    Created on : 26 Feb, 2022, 2:25:23 PM
    Author     : hp
--%>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="w3-card-4" style="cursor:pointer;background-color: white;">
                                    <div class="card-header bg-primary"><center>Change Video</center></div>
                                    <div class="card-body">
                                        <form method="post" ACTION="upload_change_video.jsp?vcode=<%=vcode%>&ccode=<%=channel_code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                                            <lable class="form-label" style="font-family:roboto;font-size: 20px;">upload video</label><br><br>
