<%-- 
    ...
    Created on : 26 Feb, 2022, 8:46:26 AM
    Author     : hp
--%>
...
<%
       try{
            if(request.getParameter("code")==null){
                    response.sendRedirect("register.jsp?code_error=1");
             }
             else{
...
<html lang="en" dir="ltr">
  ...
  <div class="container" id="rec">
    ...
    <div class="content">
        <form method="post" ACTION="upload_profile.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
            <br><input type="file" name="uploadFile" class="form-control" required><br>
