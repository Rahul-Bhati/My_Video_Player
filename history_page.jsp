<%-- 
    ...
    Created on : 15 Mar, 2022, 11:17:14 AM
    Author     : hp
--%>
    ...
    try{
            ...
            if(email==null){
               ...
               <%
                        ...
                        ResultSet rs1 = st1.executeQuery("select * from history where email = '"+email+"'");
                        while(rs1.next()){
                            ...
                            <div class="col-sm-3 video-block" id="dl-<%=rs2.getString("code")%>">
                                    ...
                                    <tr class="video-name">
                                        <td style=""><h3> <b><a href="video-page.jsp?vcode=<%=rs2.getString("code")%>" rel=""><%=rs2.getString("video_name")%></a></b> </h3>
                                             ...
                                             <span class="user">
                                                 ...
                                                 <i class='bx bxs-trash 3' rel="<%=rs2.getString("code")%>" style="color: red;" title="Remove"></i>
                                             </span>
                                        </td>
                                             <%
                                                 }   
