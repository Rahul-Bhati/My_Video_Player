<%-- 
    ...
    Created on : 26 Feb, 2022, 1:47:02 PM
    Author     : hp
--%>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="w3-card-4" style="cursor:pointer;background-color: white;">
                                    <div class="card-header bg-primary"><center>Video Upload</center></div>
                                    <div class="card-body">
                                        <form method="post" ACTION="upload_video.jsp?vcode=<%=vcode%>&ccode=<%=channel_code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                                            <lable class="form-label" style="font-family:roboto;font-size: 20px;">video file</label><br><br>
