<%-- 
    Document   : upload_change_video
    Created on : 26 Feb, 2022, 2:28:23 PM
    Author     : hp
--%>
        ...
        if(email==null){
            ...
            if(request.getParameter("vcode")==null && request.getParameter("ccode")==null){
                ...
                try
                {
                    ...
                    fileOut.flush();
                    fileOut.close();
                    response.sendRedirect("video.jsp?ccode="+channel_code+"&change_vsuccess=1");
                }
                catch (Exception e){
                    response.sendRedirect("change_video.jsp?vcode="+vcode+"&ccode="+channel_code+"&video_error=1");
