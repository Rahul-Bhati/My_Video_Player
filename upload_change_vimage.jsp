<%-- 
    Document   : upload_change_vimage
    Created on : 26 Feb, 2022, 2:18:48 PM
    Author     : hp
--%>
    ...
    try{
        ...
        if(email==null){
            ...
            if(request.getParameter("vcode")==null && request.getParameter("ccode")==null){
                response.sendRedirect("dashboard.jsp?change_vimage_code_error=1");
            }
            else{
                ...
                try
                {
                    ...
                    fileOut.flush();
                    fileOut.close();
                    response.sendRedirect("video.jsp?ccode="+channel_code+"&change_img_success=1");
                }
                catch (Exception e){
                    response.sendRedirect("video.jsp?ccode="+channel_code+"&change_img_error=1");
                }
                }
                //response.sendRedirect("index.jsp");
            }
