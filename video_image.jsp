<%-- 
    ...
    Created on : 26 Feb, 2022, 1:43:06 PM
    Author     : hp
--%>
       ...
       try{
            ...
            if(email==null){
                ...
                if(request.getParameter("vcode")==null && request.getParameter("ccode")==null){
                    response.sendRedirect("dashboard.jsp?video_img_code_error=1");
                }
                else{
                ...
                <main id="record">
                    <%
                                        if(request.getParameter("success")!=null){
                                            out.println("<h6 class='alert alert-success'>Video Created Successfully !</h6>");
                                        }
                     %>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="w3-card-4" style="cursor:pointer;background-color: white;">
                                    <div class="card-header bg-primary"><center>Image Upload</center></div>
                                    <div class="card-body">
                                        <form method="post" ACTION="upload_vimage.jsp?vcode=<%=vcode%>&ccode=<%=channel_code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                                            <lable class="form-label" style="font-family:roboto;font-size: 20px;">Video Image</label><br><br>
