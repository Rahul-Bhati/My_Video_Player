<%-- 
    Document   : upload_vimage
    Created on : 26 Feb, 2022, 1:46:15 PM
    Author     : hp
--%>
    ...
    try{
        ...
        if(email==null){
            ...
            if(request.getParameter("vcode")==null && request.getParameter("ccode")==null){
                response.sendRedirect("dashboard.jsp?vimage_code_error=1");
            }
            else{
                ...
                try
                {
                    ...
                    fileOut.flush();
                    fileOut.close();
                    response.sendRedirect("video_upload.jsp?vcode="+vcode+"&ccode="+channel_code+"&success=1");
                }
                catch (Exception e){
