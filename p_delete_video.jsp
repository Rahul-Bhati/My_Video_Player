<%-- 
    Document   : p_delete_video
    Created on : 31 Mar, 2022, 10:20:24 AM
    Author     : hp
--%>
            ...
            if(email==null){
                ...
                if(request.getParameter("ccode")==null && request.getParameter("vcode")==null){
                    ...
                    try{
                        ...
                        PreparedStatement ps = cn.prepareStatement("delete from video where code=?");
                        ps.setString(1,vcode);
                        if(ps.executeUpdate()>0){
                            response.sendRedirect("video.jsp?ccode="+channel_code+"&remove_success=1");
                        }
                        else{
                            response.sendRedirect("video.jsp?ccode="+channel_code+"&remove_again=1");
                        }
                    }
                    catch(Exception ec){
